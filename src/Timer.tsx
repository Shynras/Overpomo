...
const Timer = () => {
  ...
  const handleResult = () => {
    return (
      time.m.toLocaleString('en-us', { minimumIntegerDigits: 2 }) +
      ' : ' +
  ...
  return (
    <>
      <button type='button' className={handleStyle()} onClick={handleClick}>
        <span className='phase'>{time.p}</span>
        <br />
      ...
      <div className='pure-g'>
        ...
        <div
          className='pure-g pure-u-20-24 pure-u-md-1-2'
        ...
        >
          ...
          {active ? (
            ...
            <History time={time} setTime={setTime} />
          )}
        </div>
        <div className='pure-u-1-12 pure-u-md-1-4' />
      </div>
